    ...
    return (
        <div>
                ...
                {cartItems.map(item => (
                    <li key={item.variantId} className="flex justify-between items-center gap-5">
                        <div className="flex relative border border-stone-300 bg-stone-200 rounded-md">
                            ...
                            />
                            <span className="w-5 h-5 rounded-full bg-gray-500 text-white flex items-center justify-center 
            ...
            <div className="mt-4 p-7 space-y-5">
                <div className="flex justify-between">
                    <p className="text-sm font-medium text-stone-700">Delivery</p>
                    <p className="text-sm font-medium text-stone-600 uppercase">Free</p>
                </div>
